...
| `audit.py` | Append-only [audit log](../data-models/audit-log.md). Since Phase 6 each record carries the decision's `situation`. Appends take an exclusive flock shared with the [night cycle](../flows/night-cycle.md) |
