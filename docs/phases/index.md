...
| [01](phase-01-brain.md) | Brain layer | todo | 0/6 | 00 |
| [02](phase-02-agents.md) | Agent layer | todo | 0/4 | 01 |
...
Current phase: **phase-01-brain**. Resume point: [state.md](../context/state.md).
